    ...
    return (
        ...
        <div className="flex justify-between">
            <div>
                ...
                { msg.image ? <img loading="lazy" className="max-h-80 max-w-[75%]" src={msg.image} alt="Imagen enviada" /> : ""}
            </div>

            <div className="flex">
                <p className="flex items-center">{msg.hora}</p>

                <button title="Eliminar" onClick={deleteMsg} className="mx-1 my-auto w-min flex items-center hover:opacity-70"><IconTrash/></button>

                <button title="Opciones" className="relative w-min my-auto flex items-center">
